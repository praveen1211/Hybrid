package extentreports;
	...
	public class Screenshot 
	{
		String imagepath;
		File f;
	public Screenshot(WebDriver driver, String dest){
		imagepath="C:\\Users\\miracle\\workspace\\Hybrid-driven-framework\\screenshot"+dest+".png";
		try {
	...
	public String subImage(WebElement element, String dest) throws Exception{
		String subPath="C:\\Users\\miracle\\workspace\\Hybrid-driven-framework\\screenshot"+dest+".png";
